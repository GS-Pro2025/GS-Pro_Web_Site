const QuoteForm = () => {
  return (
    <div className="opacity-80 bg-white p-6 rounded-lg shadow-xl w-[90%] max-w-[350px] min-h-[350px] border-2 border-[#2E1EA5] mx-auto ease-out hover:opacity-90 font-['Roboto']">
