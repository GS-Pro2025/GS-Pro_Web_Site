...
const inConstruction = () => {
    return (
        <div className="font-[Open_Sans] bg-[#d9d9d9] flex flex-col items-center justify-center h-screen text-center">
            <img src={logo} className="max-w-80 sm:max-w-90 md:max-w-100"></img>
            <h1 className="text-4xl text-red-500">Page Under Construction</h1>
