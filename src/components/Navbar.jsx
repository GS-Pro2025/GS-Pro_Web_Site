...
const Navbar = () => {
    ...
    return (
        <nav className="font-[Open_Sans] fixed z-50 w-full flex items-center p-2 transition-all duration-300 bg-white/80 shadow-md top-0 left-0">
            <div className="max-w-[1200px] mx-auto px-6 flex items-center justify-between w-full h-full">
                ...
                >
                    <div className="flex flex-col md:flex-row md:items-center w-full md:w-auto text-[#0458AB]">
                        <Link
                            to="/aboutUs"
                            className="text-[#0458AB] text-xl cursor-pointer px-6 py-3 block md:inline"
                        >
                            About us
                        </Link>
                        <Link
                        ...
                        <Link
                            to="/contactUs"
                            className="bg-[#003B73] text-sky-400 border border-sky-400 border-b-4 overflow-hidden relative px-4 py-2 rounded-md hover:brightness-150 hover:border-t-4 hover:border-b active:opacity-75 outline-none duration-300 group"
                        >
